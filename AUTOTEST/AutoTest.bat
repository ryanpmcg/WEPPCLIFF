...
"%PathToRscript%" --vanilla "%PathToWEPPCLIFF%" --args -o AUTOTEST/OUTPUT -e AUTOTEST/OUTPUT -fn AutoTest.1 -f ASOS_BPT_KMQE.csv -la y -verb t -ed 1
"%PathToRscript%" --vanilla "%PathToWEPPCLIFF%" --args -o AUTOTEST/OUTPUT -e AUTOTEST/OUTPUT -fn AutoTest.2 -f AH537_BPT_CP.csv -cp t -u m PRECIP -sm 2 -la y -verb t -ei t -ee ARS -ipb t -pd t -ed 1
"%PathToRscript%" --vanilla "%PathToWEPPCLIFF%" --args -o AUTOTEST/OUTPUT -e AUTOTEST/OUTPUT -fn AutoTest.3 -f AH537_BPT_IP.csv -cp f -u m PRECIP -sm 2 -la y -verb t -ei t -ee ARS -ipb t -pd t -ed 1
"%PathToRscript%" --vanilla "%PathToWEPPCLIFF%" --args -o AUTOTEST/OUTPUT -e AUTOTEST/OUTPUT -fn AutoTest.4 -f AH537_1MIN_UP.csv -pi 1 -cp f -u m PRECIP -sm 2 -la y -verb t -ei t -ee ARS -ipb t -pd t -ed 1
"%PathToRscript%" --vanilla "%PathToWEPPCLIFF%" --args -o AUTOTEST/OUTPUT -e AUTOTEST/OUTPUT -fn AutoTest.5 -f AH537_1MIN.csv -pi 1 -cp f -u m PRECIP -sm 2 -la y -verb t -ei t -ee ARS -ipb t -pd t -ed 1
"%PathToRscript%" --vanilla "%PathToWEPPCLIFF%" --args -o AUTOTEST/OUTPUT -e AUTOTEST/OUTPUT -fn AutoTest.6 -f AH537_5MIN.csv -pi 5 -cp f -u m PRECIP -sm 2 -la y -verb t -ei t -ee ARS -ipb t -pd t -ed 1
"%PathToRscript%" --vanilla "%PathToWEPPCLIFF%" --args -o AUTOTEST/OUTPUT -e AUTOTEST/OUTPUT -fn AutoTest.7 -f AH537_10MIN.csv -pi 10 -cp f -u m PRECIP -sm 2 -la y -verb t -ei t -ee ARS -ipb t -pd t -ed 1
"%PathToRscript%" --vanilla "%PathToWEPPCLIFF%" --args -o AUTOTEST/OUTPUT -e AUTOTEST/OUTPUT -fn AutoTest.8 -f AH537_15MIN.csv -pi 15 -cp f -u m PRECIP -sm 2 -la y -verb t -ei t -ee ARS -ipb t -pd t -ed 1
