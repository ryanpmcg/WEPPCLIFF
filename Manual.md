...
ed|export data|0|0 / 1 / 2 / 3 / 4 / 5|determines whether or not to generate binary or human readible, output of internal calculations; (0) no files written; (1) .rds binary files written; (2) .json text files written; (3-5) .csv text files written with precipitation, daily, or storm timeseries dataframes, respectively
